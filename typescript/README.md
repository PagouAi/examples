...
Idiomatic TypeScript/Node examples using a minimal HTTP client. A `@pagouai/api-sdk` variant may be
added alongside a raw-HTTP reference for cross-language parity.
